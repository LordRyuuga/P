...
FalknerGroup:
	...
	dbp 11, MURKOW
		db NO_ITEM
		ev_spread 32 HP
		db SUCKER_PUNCH, GUST, MUD_SLAP, HAZE
	dbp 11, SKARMORY
		db NO_ITEM
		ev_spread 32 HP
		db STEEL_WING, FURY_STRIKES, PECK, ROOST
	dbp 13, PIDGEOTTO
		db PECHA_BERRY
		ev_spread 32 HP
...
BugsyGroup:
	...
	; party
	dbp 15, BUTTERFREE, MALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL
		ev_spread 32 SAt, 32 Spe
		db GUST, POISONPOWDER, SLEEP_POWDER, PSYBEAM
	dbp 15, BEEDRILL, MALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL
		ev_spread 32 Atk, 32 Spe
		db POISON_JAB, KNOCK_OFF, U_TURN, FURY_STRIKES
	dbp 16, YANMA, FEMALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL
		ev_spread 64 Atk
	...
	dbp 18, SCYTHER, MALE
		db NO_ITEM, ABILITY_1 | NAT_NEUTRAL
		ev_spread 64 Atk
		db QUICK_ATTACK, SWORD_DANCE, WING_ATTACK, U_TURN
	db -1 ; end
...
FedmaeGroup:
	...
	dbp 51, SYLVEON, FEMALE
		...
		db DAZZLINGLEAM, LIGHT_SCREEN, REFLECT, DRAIN_KISS
	dbp 55, XATU, MALE
...
UnknownGroup:
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_PERSONALITY | TRAINERTYPE_MOVES
	; party
	dbp 60, TYPHLOSION, MALE | HISUIAN_FORM
